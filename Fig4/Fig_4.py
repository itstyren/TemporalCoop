...
conf.read('./Config_Fig4.ini', encoding='UTF-8')
...
def plot_evolutionary_processes_with_one_param(single_iterator_list,
    ...
    if mode == 'hpc_to_local':
        ...
        if switch_fuc == 'a':
            ...
            Nr = 2
            Nc = len(single_iterator_list) // 2
            fig_1 = plt.figure(num='fig_1', figsize=(8, 12))
        ...
        # Plot Fig.4 (*-2) to (*-6)
            ...
            # all_record_list = all_record_list[1]    # subfig (b-*)
            strategy_data = []
            state_data = []
            for t in time_set:
            ...
            Nr = 1
            Nc = len(time_set)
            fig_1 = plt.figure(num='fig_1', figsize=(20, 5))
...
def main():
    if switch_fuc == 'a':
        plot_evolutionary_processes_with_one_param(
            p_iterator_list, toolbox.retrieve_name(p_iterator_list))
    elif switch_fuc == 'b':
        plot_evolutionary_processes_with_one_param(
